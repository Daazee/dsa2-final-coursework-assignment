...
def backtracking_tour(board, x, y, step, is_closed, start_x, start_y):
    if step == 64:
    ...
    for dx, dy in knight_moves:
        ...
        if is_valid_move(next_x, next_y, board):
            ...
            if backtracking_tour(board, next_x, next_y, step + 1, is_closed, start_x, start_y):
                return True
...
if user_approach_choice == "2":
    ...
    success = backtracking_tour(chessboard, start_x, start_y, 1, is_closed, start_x, start_y)

#print final chessboard state
print("Final chess board state\n")
for row in chessboard:
